...
> Dernière mise à jour : 4 août 2026 · Version 1.28
...
|---|---|---|
| `R-FOYER-04` | **Verrouillage horaire foyer** : faut-il rétablir un verrou de dernière minute (impossible de déclarer/annuler une absence pour la nuit même après une heure donnée, pour fiabiliser le décompte du soir) ? Le modèle « séjours » l'a abandonné. | ⏳ À confirmer |
| `R-FOYER-05` | **Absences sur dates passées** : autorise-t-on la création/modification d'un séjour dans le passé (régularisation) ou faut-il le bloquer ? | ⏳ À confirmer |
