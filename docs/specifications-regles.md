...
> Dernière mise à jour : 3 août 2026 · Version 1.22
...
| ID | Règle |
|---|---|
| **R-NIV-01** | *(MàJ 2026-07-25.)* Les droits sont attribués **par section** de l'appli : **Repas · Événements · Absences · Comptes · Infos pratiques**. Sur chaque section, une résidente a un niveau **1 Aucun · 2 Lecture · 3 Édition**. S'ajoute un rôle global **Super-admin** (tous droits partout **+** seul à attribuer les droits + gérer/supprimer les comptes). Les **invitées** sont hors hiérarchie (aucun droit admin). |
| **R-NIV-02** | *(MàJ 2026-07-25.)* Les niveaux sont **par section** (plus de niveau global unique). Correspondance des sections → écrans : **Repas** (visu repas, paramétrage/options, verrouillage repas, édition des inscriptions) · **Événements** (calendrier admin) · **Absences** (vue Présence foyer + marquage) · **Comptes** (comptes, chambres/places, invitations, paramètres généraux) · **Infos pratiques** (rubriques Administratif). Le bouton ⚙️ Administration correspond à la section **Comptes**. |
...
| **R-NIV-07** | La **suppression définitive d'un compte** résidente est **réservée au super-admin** (ou compte technique) — irréversible, trop dangereuse pour l'édition courante. L'**archivage** (libération de place, historique conservé) reste accessible à l'édition **Comptes** (niveau ≥ 3). |
...
| **R-NIV-10** | *(Nouveau 2026-08-01.)* **« Aucun » ne retire jamais la vue de résidente.** Sur chaque section, le niveau 1 laisse l'habitante utiliser l'appli normalement (voir les événements et les rappels, s'inscrire à ses repas, déclarer ses absences, lire les rubriques Administratif) ; il ne retire que les fonctions d'**intendance**. Pour la section **Événements** : **1 Aucun** = voir les événements et les rappels, confirmer sa participation · **2 Lecture** = voir en plus **qui s'est inscrit** et les événements **réservés au staff** · **3 Édition** = créer / modifier / supprimer. Le panneau « Droits » affiche cette explication sous chaque section. |
